...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Generate YOLO patch dataset from raw images and JSON labels.")
    ...
    parser.add_argument("--include-empty", action="store_true", help="Keep background patches with empty labels.")
...
def main() -> None:
    args = parse_args()
    generate_dataset(args.image_dir, args.label_dir, args.dst_root, parse_class_map(args.class_map), args.class_names, args.roi, args.patch_size, args.overlap, args.include_empty, args.valid_ratio, args.test_ratio, args.seed, args.image_exts, args.overwrite)
